...
implementation {
  ...
  components new AMReceiverC(AM_THLRADIO) as AMTransReceiver;
  components new AMReceiverC(AM_ACKRADIO) as AMackReceiver;
  ...
  node1C.transReceive -> AMTransReceiver;
  node1C.ackReceive -> AMackReceiver;
